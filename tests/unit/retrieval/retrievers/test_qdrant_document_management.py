"""
QdrantRetriever 문서 관리 메서드 단위 테스트
...
from app.modules.core.retrieval.retrievers.qdrant_retriever import QdrantRetriever


@pytest.mark.unit
class TestQdrantDocumentManagement:
    """QdrantRetriever 문서 관리 테스트"""
