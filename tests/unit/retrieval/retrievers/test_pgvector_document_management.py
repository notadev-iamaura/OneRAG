"""
PgVectorRetriever 문서 관리 메서드 단위 테스트
...
from app.modules.core.retrieval.retrievers.pgvector_retriever import PgVectorRetriever


@pytest.mark.unit
class TestPgVectorDocumentManagement:
    """PgVectorRetriever 문서 관리 테스트"""
    ...
    async def test_get_collection_info(self, retriever, mock_store):
        ...
        assert result["collection_name"] == "test_documents"
