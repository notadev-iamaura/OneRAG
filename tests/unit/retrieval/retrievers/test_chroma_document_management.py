"""
ChromaRetriever 문서 관리 메서드 단위 테스트
...
@pytest.mark.unit
class TestChromaDocumentManagement:
    """ChromaRetriever 문서 관리 테스트"""
    ...
    @pytest.mark.asyncio
    async def test_get_document_chunks_returns_all_chunks(self, retriever, mock_store):
        ...
        mock_store.fetch_objects.assert_called_once()

    @pytest.mark.asyncio
    async def test_get_document_chunks_returns_empty_for_nonexistent(self, retriever, mock_store):
    ...
    @pytest.mark.asyncio
    async def test_delete_document_removes_all_chunks(self, retriever, mock_store):
        """문서의 모든 청크 삭제"""
        mock_store.fetch_objects.return_value = [
            {"_id": "id-1", "content": "a", "document_id": "doc-1"},
            {"_id": "id-2", "content": "b", "document_id": "doc-1"},
        ]
    ...
    @pytest.mark.asyncio
    async def test_delete_document_nonexistent_returns_false(self, retriever, mock_store):
    ...
    @pytest.mark.asyncio
    async def test_list_documents_with_pagination(self, retriever, mock_store):
        """문서 목록 페이지네이션 조회"""
        mock_store.fetch_objects.return_value = [
            {"_id": "id-1", "content": "a", "document_id": "doc-1", "source_file": "a.pdf", "file_type": "PDF", "created_at": "2024-01-01"},
            {"_id": "id-2", "content": "b", "document_id": "doc-1", "source_file": "a.pdf", "file_type": "PDF", "created_at": "2024-01-01"},
            {"_id": "id-3", "content": "c", "document_id": "doc-2", "source_file": "b.txt", "file_type": "TXT", "created_at": "2024-06-01"},
        ]
    ...
    @pytest.mark.asyncio
    async def test_list_documents_empty_collection(self, retriever, mock_store):
        """빈 컬렉션에서 목록 조회"""
        mock_store.fetch_objects.return_value = []
    ...
    @pytest.mark.asyncio
    async def test_get_document_details_returns_info(self, retriever, mock_store):
        """문서 상세 정보 반환"""
        mock_store.fetch_objects.return_value = [
            {"_id": "id-1", "content": "첫 번째 청크 내용", "document_id": "doc-1", "source_file": "report.pdf", "file_type": "PDF", "chunk_index": 0, "created_at": "2024-01-15"},
            {"_id": "id-2", "content": "두 번째 청크 내용", "document_id": "doc-1", "source_file": "report.pdf", "file_type": "PDF", "chunk_index": 1, "created_at": "2024-01-15"},
        ]
    ...
    @pytest.mark.asyncio
    async def test_get_document_details_nonexistent_returns_none(self, retriever, mock_store):
    ...
    @pytest.mark.asyncio
    async def test_get_document_stats_returns_counts(self, retriever, mock_store):
        """문서/벡터 수량 통계"""
        mock_store.fetch_objects.return_value = [
    ...
    @pytest.mark.asyncio
    async def test_get_collection_info_returns_metadata(self, retriever, mock_store):
        """컬렉션 메타정보 반환"""
        mock_store.fetch_objects.return_value = [
            {"_id": "id-1", "document_id": "doc-1", "content": "a", "created_at": "2024-01-01"},
            {"_id": "id-2", "document_id": "doc-2", "content": "b", "created_at": "2024-12-01"},
        ]
    ...
    async def test_delete_all_documents(self, retriever, mock_store):
        ...
        mock_store.fetch_objects.return_value = [
            {"_id": "id-1", "document_id": "doc-1", "content": "a"},
            {"_id": "id-2", "document_id": "doc-2", "content": "b"},
        ]
    ...
    async def test_backup_metadata(self, retriever, mock_store):
        ...
        mock_store.fetch_objects.return_value = [
            ...
            {"_id": "id-2", "content": "b", "document_id": "doc-2", "source_file": "b.txt", "file_type": "TXT", "chunk_index": 0, "created_at": "2024-06-01"},
        ]
